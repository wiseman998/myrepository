...
<title>关于平台信息设置</title>
<meta name="keywords" content="">
<meta name="description" content="">
</head>
<body>
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('System/setabout');?>" method="post"   enctype="multipart/form-data">
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($about["title"]); ?>" placeholder="" id="title" name="title">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">关于平台内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<script name="detail" id="editor" type="text/plain" style="width:100%;height:400px;"><?php echo ($about["detail"]); ?></script> 
			</div>
		</div>
		<div class="row cl">
